...
<body style="background:url(images/bg.jpg) no-repeat;" onload="msg()">
    
    <div class="container wrap1" style="height:450px;">
            <h2 class="mg-b20 text-center">爱新海点歌管理员登入页面</h2>
            <div class="col-sm-8 col-md-5 center-auto pd-sm-50 pd-xs-20 main_content">
                <p class="text-center font16">用户登录</p>
                <form id="Loginfrom" action=""   Method="Post">
                    <div class="form-group mg-t20">
                        <i class="icon-user icon_font"></i>
                        <input type="text" class="login_input" name="AdminUserName" placeholder="请输入用户名" />
                    </div>
                    <div class="form-group mg-t20">
                        <i class="icon-lock icon_font"></i>
                        <input type="password" class="login_input" name="AdminUserPassword" placeholder="请输入密码" />
                    </div>
                    <div class="checkbox mg-b25">
                        <input type="hidden" class="login_input" name="methods" value="AdminLogin" />
                    </div>
                    <button  class="login_btn"   onclick="zijian()">登 录</button>
